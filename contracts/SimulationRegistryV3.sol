...
/**
 * @title SimulationRegistryV3
 * @notice On-chain registry for ArbiSim Guard pre-flight simulation results (V3 with Evidence Hash binding).
 * @dev Deployed on Arbitrum Sepolia / Fuji and Mainnets.
 * @custom:version 3
 */
contract SimulationRegistryV3 {
    ...
    struct SimulationRecord {
        ...
        uint32 chainId;
        uint32 timestamp;
        bytes32 evidenceHash; // Added in v3
    }
    ...
    function logSimulation(
        ...
        emit SimulationLogged(sessionId, agent, safeToExecute, flagsBitmap, chainId, evidenceHash);
    }
